...
public class ArrowTranslator
{
  ...
  public ArrowDirection TranslateDirection(OverlayTileController previousTile, OverlayTileController currentTile, OverlayTileController futureTile)
  {
    ...
    {
      if (pastDirection.y < futureDirection.y) // moving down
